...
const excerptSize = 440;


const BlogPostHorizontal= (props)=>{
    const {id}= props
    const { classes } = props;
    ...
    return(
        <Card className="d-flex my-1 row">
        {mediaUrl && (
          <CardBody
          ...
          >
            <Avatar
              ...
              style={{
                ...
                maxHeight: "360px", // Set your desired max height
              }}
            />
          </CardBody>
        )}

            <CardBody className="col-xs-12 col-sm-6">
...
export default withStyles(useStyles)(BlogPostHorizontal);